...
export const Jump = () => {
    return (
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" id = "Skills">
        ...
        <div className="mb-10 sm:text-center">
          ...
          <div>
            ...
            <p className="text-sm font-medium leading-4 text-gray-600">Developer</p>
          </div>
        </div>
